...
class LoggingAdapter:
    ...
    def add_file_handler(self, log_file: str, level: Optional[Union[int, DebugLevel]] = None) -> None:
        """
    ...
    def debug(self, message: str, symbol: Optional[str] = None, agent: Optional[str] = None) -> None:
        """
        Log a debug message.
    ...
    def warning(self, message: str, symbol: Optional[str] = None, agent: Optional[str] = None) -> None:
        """
    ...
    def error(self, message: str, symbol: Optional[str] = None, agent: Optional[str] = None) -> None:
        """
    ...
    def critical(self, message: str, symbol: Optional[str] = None, agent: Optional[str] = None) -> None:
        """
    ...
    def _format_message(self, message: str, symbol: Optional[str] = None, agent: Optional[str] = None) -> str:
        """
