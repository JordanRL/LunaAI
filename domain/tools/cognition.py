...
- growth: Considering Luna's development and changes over time""",
            input_schema={
                ...
                "properties": {
                    "reflection_topic": {
                        "type": "string",
                        "description": "Topic to reflect upon"
                    },
                    "reflection_type": {
                        "type": "string",
    ...
    def handle(self, tool_input: Dict[str, Any]) -> Dict[str, Any]:
        ...
        log(f"Performing {reflection_type} reflection on: {reflection_topic[:50]}...",
           DebugLevel.STANDARD, debug_manager.symbols.THINKING)
        ...
        insight = reflection_outputs.get(reflection_type, "Luna gained new insights through reflection.")
