...
from domain.models.memory import (
    ...
    MemoryQuery, EpisodicMemoryQuery, SemanticMemoryQuery, EmotionalMemoryQuery, RelationshipMemoryQuery,
    MemoryResult
)
...
class TestMemoryService(unittest.TestCase):
    ...
    def test_update_memory(self):
        ...
        self.mock_es_adapter.update_memory.assert_called_once_with(
            "test123", 
            {"importance": 8}
        )
    ...
    def test_memory_type_conversion(self):
        ...
        self.assertEqual(relationship.shared_experiences, ["project collaboration", "coffee meetings"])
